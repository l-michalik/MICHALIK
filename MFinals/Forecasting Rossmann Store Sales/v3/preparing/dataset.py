...
from v3.utils.main import (
    ...
    has_competition_months, has_promo2_weeks, latest_promo2_months
)
...
def prepare_dataset() -> None:
    ...
    dump((X_train, y_train), JOBLIB_DIR / "feature_train_data.joblib")
    dump(X_test, JOBLIB_DIR / "feature_test_data.joblib")
